...
from icecreamrating_v2.users.models import User
from icecreamrating_v2.users.tests.factories import UserFactory
from icecreamrating_v2.users.views import (
    UserRedirectView,
    UserUpdateView,
    user_detail_view,
)
